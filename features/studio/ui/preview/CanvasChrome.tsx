...
import { toolGroups, type AddBlockType, type StudioBlockTool, type StudioToolGroup } from "@/features/studio/ui/studioOptions";
...
export function CanvasBlockDock({ onAddBlock }: { onAddBlock: (type: AddBlockType, options?: AddBlockOptions) => void }) {
  const [openGroupId, setOpenGroupId] = useState<StudioToolGroup["id"] | null>(null);
