...
export function createMotionDocBlock(type: AddBlockType): MotionDocBlock {
  ...
  switch (type) {
    case "Title":
      return { type: "Title", props: { enter: "fadeUp", fontSize: 72, radius: 0, x: 9, y: 18, w: 52, h: 18 }, text: "New Title" } as MotionDocBlock;
    case "Text":
      return { type: "Text", props: { enter: "fadeUp", delay: defaultDelay, fontSize: 24, radius: 0, x: 10, y: 45, w: 42, h: 16 }, text: "Add some descriptive text here." } as MotionDocBlock;
    case "Text96":
    ...
    case "Card":
      return { type: "Card", props: { icon: "Sparkles", layout: "vertical", title: "Feature", text: "Feature description", width: "md", enter: "fadeUp", delay: defaultDelay, radius: 16, x: 8, y: 38, w: 40, h: 32 } } as MotionDocBlock;
    case "Metric":
      return { type: "Metric", props: { label: "Pipeline", value: "$2.4M", caption: "Qualified revenue influenced this quarter.", width: "sm", enter: "fadeUp", delay: defaultDelay, radius: 16, x: 8, y: 38, w: 32, h: 36 } } as MotionDocBlock;
    case "Chart":
    case "ChartBar":
    ...
    case "Image":
      return { type: "ImageBlock", props: { src: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&q=80&w=800", alt: "Retro Setup", fit: "cover", enter: "fadeIn", delay: defaultDelay, radius: 16, x: 10, y: 20, w: 80, h: 54 } } as MotionDocBlock;
    case "Video":
      return { type: "VideoBlock", props: { src: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4", fit: "cover", controls: "true", loop: "true", muted: "true", enter: "fadeIn", delay: defaultDelay, radius: 16, x: 10, y: 20, w: 80, h: 54 } } as MotionDocBlock;
    case "Icon":
      return { type: "Icon", props: { icon: "Sparkles", color: "#ffffff", strokeWidth: 2.2, size: 112, enter: "zoomIn", delay: defaultDelay, radius: 0, x: 42, y: 28, w: 16, h: 28 } } as MotionDocBlock;
    case "ShapeRectangle":
...
function createTextPresetBlock(fontSize: number, text: string): MotionDocBlock {
  ...
  return {
    ...
    props: {
      ...
      h: fontSize >= 60 ? 24 : fontSize >= 36 ? 18 : 14
    },
    text
  } as MotionDocBlock;
}
