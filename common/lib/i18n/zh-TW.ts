export const zhTwDictionary = {
    ...
    home: {
      ...
      downloadTeaser: {
        title: "Mac Beta 已可下載。",
        body: "SlideX Tauri 2.0.2 已放上 macOS Apple Silicon DMG，可先分享給早期使用者測試桌面版流程。",
        cta: "下載 Mac Beta",
  ...
  Position with percent-based frame props.
    ...
    downloadPage: {
      ...
      packageCard: {
        ...
        items: ["Tauri 桌面 2.0.2", "自動繞過 Gatekeeper 安全檢查", "延續 Web Studio 的 MDX 場景模型", "2026.06.06 版本資訊"],
