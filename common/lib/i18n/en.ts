export const enDictionary = {
    ...
    home: {
      ...
      downloadTeaser: {
        ...
        body: "SlideX Tauri 2.0.1 is now available as a macOS Apple Silicon DMG for early desktop workflow testing.",
  ...
  Position with percent-based frame props.
    ...
    downloadPage: {
      ...
      packageCard: {
        ...
        items: ["Tauri desktop 2.0.1", "Automated Gatekeeper security bypass", "Same MDX scene model as Web Studio", "2026.06.06 release notes"],
