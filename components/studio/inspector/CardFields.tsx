...
import { cardLayoutOptions, cardWidthOptions } from "@/components/studio/studioOptions";
...
export function CardFields({ block, selectedBlockIndex, updateBlock }: BlockFieldProps) {
  return (
    <>
      ...
      <OptionButtons label="Card width" options={cardWidthOptions} value={String(block.props.width ?? "md")} onChange={(value) => updateBlock(selectedBlockIndex, { ...block.props, width: value })} />
