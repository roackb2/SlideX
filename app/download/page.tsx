  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#080a0f] text-neutral-200">
      ...
      <section className="relative px-6 pt-24">
        ...
        <div className="mx-auto grid min-h-[calc(100dvh-6rem)] max-w-7xl gap-10 pb-16 md:pb-20 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-2xl">
            ...
            <motion.div variants={fadeInUp} custom={3} className="mt-8 flex flex-wrap items-center gap-3">
              <button
                className="inline-flex cursor-not-allowed items-center gap-2 whitespace-nowrap rounded-full bg-white/60 px-6 py-3 text-sm font-semibold text-black"
                disabled
                type="button"
              >
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-white/[0.12] bg-[#0d1018] p-5 shadow-2xl shadow-black/50 md:p-7">
      ...
      <section className="px-6 py-24 md:py-32">
        <div className="mx-auto max-w-7xl">
          <motion.div
            ...
            className="grid gap-8 rounded-[32px] border border-white/[0.1] bg-white/[0.045] p-6 md:p-10 lg:grid-cols-[1fr_0.8fr] lg:items-center"
          >
            <div>
